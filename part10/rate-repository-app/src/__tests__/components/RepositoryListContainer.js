...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      render(<RepositoryListContainer repositories={repositories} loading={false} error={false}/>)
      ...
      expect(firstRepositoryItem).toHaveTextContent('1.6k'); // 1619 forks
      expect(firstRepositoryItem).toHaveTextContent('21.9k'); // 21856 stars
      ...
      expect(secondRepositoryItem).toHaveTextContent('1.8k'); // 1760 stars
